...
const Dashboard = () => {
    ...
    return (
        <div className="h-[90vh] flex flex-col justify-between relative">
            ...
            <div className="bg-card p-4 border-t flex items-center sticky bottom-0 w-full">
            ...
            {loading && (
                <div className="absolute inset-0 flex items-center justify-center bg-gray-700 bg-opacity-75 z-50 h-full">
                    <BookLoader />
                </div>
            )}
        </div>
